...
public interface DictionaryValueRepository extends JpaRepository<DictionaryValue, Long>, JpaSpecificationExecutor<DictionaryValue> {
     ...
     * @return 下一个序号
     */
    public default Integer findNextSerialNumber(Long dictionaryTypeId) {
    ...
    public Integer findMaxSerialNumber(Long dictionaryTypeId);
     ...
     * @return 字典项值的数目
     */
    public Long countByDictionaryTypeId(Long dictionaryTypeId);
}
