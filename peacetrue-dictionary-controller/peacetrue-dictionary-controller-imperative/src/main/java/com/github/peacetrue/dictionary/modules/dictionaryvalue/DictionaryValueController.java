...
public class DictionaryValueController {
    ...
    public DictionaryValueVO add(@RequestBody DictionaryValueAdd params) {
     ...
     */
    @GetMapping("/{id}")
    public DictionaryValueVO get(@PathVariable Long id, String... projection) {
    ...
    public Integer modify(@RequestBody DictionaryValueModify params) {
