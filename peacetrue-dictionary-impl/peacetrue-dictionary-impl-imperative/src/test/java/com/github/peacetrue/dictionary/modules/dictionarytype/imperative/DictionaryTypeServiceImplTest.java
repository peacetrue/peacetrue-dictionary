...
import com.github.peacetrue.dictionary.imperative.DictionaryServiceTestAutoConfiguration;
...
import static com.github.peacetrue.dictionary.imperative.DictionaryServiceTestAutoConfiguration.DICTIONARY_TYPE;
import static com.github.peacetrue.dictionary.imperative.DictionaryServiceTestAutoConfiguration.DICTIONARY_VALUE;
...
class DictionaryTypeServiceImplTest {
    ...
    @Order(70)
    void delete() {
        Assertions.assertEquals(1, dictionaryValueService.delete(new DictionaryValueDelete().setId(DICTIONARY_VALUE.getId())));
        Assertions.assertEquals(1, service.delete(new DictionaryTypeDelete().setId(DICTIONARY_TYPE.getId())));
    }
}
