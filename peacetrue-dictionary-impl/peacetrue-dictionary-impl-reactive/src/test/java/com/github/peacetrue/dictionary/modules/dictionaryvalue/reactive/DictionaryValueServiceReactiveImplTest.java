...
class DictionaryValueServiceReactiveImplTest {
    ...
    void add() {
        ...
        TransactionalOperator.create(transactionManager)
                .execute(status -> {
                    ...
                    return dictionaryValueService.add(add);
                })
    ...
    void queryForPage() {
        ...
        dictionaryValueService.queryPage(params, PageableUtils.PAGEABLE_DEFAULT)
                .as(StepVerifier::create)
    ...
    void queryForList() {
        ...
        dictionaryValueService.queryList(query, PageableUtils.PAGEABLE_DEFAULT)
                .as(StepVerifier::create)
    ...
    @Order(40)
    void get() {
        dictionaryValueService.get(BeanUtils.convert(DICTIONARY_VALUE, DictionaryValueGet.class))
                .as(StepVerifier::create)
                .assertNext(vo -> ReflectionAssert.assertReflectionEquals(DICTIONARY_VALUE, vo))
                .verifyComplete();
    }
    ...
    void modify() {
        TransactionalOperator.create(transactionManager)
                .execute(status -> {
                    status.setRollbackOnly();
                    return dictionaryValueService.modify(BeanUtils.convert(DICTIONARY_VALUE, DictionaryValueModify.class));
                })
                .as(StepVerifier::create)
