...
import com.github.peacetrue.dictionary.reactive.DictionaryServiceTestAutoConfiguration;
...
import static com.github.peacetrue.dictionary.reactive.DictionaryServiceTestAutoConfiguration.DICTIONARY_TYPE;
import static com.github.peacetrue.dictionary.reactive.DictionaryServiceTestAutoConfiguration.DICTIONARY_VALUE;
...
class DictionaryTypeServiceImplTest {
    ...
    void add() {
        ...
        TransactionalOperator.create(reactiveTransactionManager)
                .execute(status -> {
                    ...
                    return dictionaryTypeService.add(add);
                })
    ...
    void queryForPage() {
        ...
        dictionaryTypeService.queryPage(params, PageableUtils.PAGEABLE_DEFAULT)
                .as(StepVerifier::create)
    ...
    void queryForList() {
        ...
        dictionaryTypeService.queryList(query, PageableUtils.PAGEABLE_DEFAULT)
                .as(StepVerifier::create)
    ...
    @Order(40)
    void get() {
        dictionaryTypeService.get(BeanUtils.convert(DICTIONARY_TYPE, DictionaryTypeGet.class))
                .as(StepVerifier::create)
                .assertNext(vo -> ReflectionAssert.assertReflectionEquals(DICTIONARY_TYPE, vo))
                .verifyComplete();
    }
    ...
    void modify() {
        TransactionalOperator.create(reactiveTransactionManager)
                .execute(status -> {
                    status.setRollbackOnly();
                    return dictionaryTypeService.modify(BeanUtils.convert(DICTIONARY_TYPE, DictionaryTypeModify.class));
                })
                .as(StepVerifier::create)
        ...
        TransactionalOperator.create(reactiveTransactionManager)
                .execute(status -> {
                    ...
                    return dictionaryValueService.delete(new DictionaryValueDelete().setId(DICTIONARY_VALUE.getId()))
                            .then(dictionaryTypeService.delete(new DictionaryTypeDelete().setId(DICTIONARY_TYPE.getId())));
                })
                .as(StepVerifier::create)
                .expectNext(1)
                .verifyComplete();
